...
<body>
<div id="large-header" class="large-header" style="overflow: hidden;">
	<canvas id="demo-canvas"></canvas>
	<div class="passreset">
		<h1 style="text-align: center">Enter new password</h1>
		<hr style="border: 1px solid #232323;">
		<?= validation_errors(); ?>
		<?= form_open('PasswordResetController/newpassword'); ?>
			...
			<br>
			<input type="submit" value="Submit" name="submit" class="button is-primary">
		</form>
	</div>
</div>
